...
mFLOCSS × Vite × Sass(SCSS) で作る、崩れない CSS 設計のひな型です。
...
1. `src/sass/component/_c-card.scss` を作成
2. `@layer component { }` で囲んで記述
3. `src/sass/style.scss` に `@use 'component/c-card';` を追加
